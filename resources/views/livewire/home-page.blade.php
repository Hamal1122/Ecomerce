<div>
    <div class="w-full h-screen bg-gradient-to-r from-slate-900 to-slate-800 py-10 px-4 sm:px-6 lg:px-8 mx-auto">
        <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
          <!-- Grid -->
          <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
            <div>
              <h1 class="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">Start your journey with <span class="text-blue-600">E-Comerce</span></h1>
      ...
      <section class="py-20">
       ...
       <!-- customer section -->
       <section class="py-14 font-poppins dark:bg-slate-700">
